...
namespace SkeFramework.NetSocket.Net
{
    ...
    public abstract class ReactorResponseChannel : IConnection
    {
        ...
        public void Close()
        {
            ...
            {
                NetworkEventLoop.Disconnection(new SocketConnectionException(ExceptionType.Closed), this);
            }
            EventLoop.Dispose();
        }
        ...
        protected void InvokeErrorIfNotNull(Exception ex)
        {
            ...
            {
                throw new SkeException("Unhandled exception on a connection with no error handler", ex);
            }
        }
