...
namespace SkeFramework.Core.WebSocketPush.PushServices
{
    ...
    {
        static WebSocketSession _instance;
        public static WebSocketSession Instance => _instance ?? throw new Exception("使用前请初始化 Initialization(...);");

        /// <summary>
        /// 初始化 ImHelper
        /// </summary>
        /// <param name="options"></param>
        public static void Initialization(WebSocketSessionOptions options)
        {
            _instance = new WebSocketSession(options);
        }
