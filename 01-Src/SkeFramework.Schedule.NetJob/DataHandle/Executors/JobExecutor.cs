...
namespace SkeFramework.Schedule.NetJob.DataHandle.Executors
{
    public class JobExecutor
    {
        ...
        internal JobExecutor(string name, IServiceProvider services, CancellationToken cancellationToken, TypeInfo typeInfo, MethodInfo method, JobSchedule[] schedule, bool allowConcurrentExecution, bool runImmediately)
        {
