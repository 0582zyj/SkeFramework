...
namespace SkeFramework.Schedule.NetJob.CronExpression
{
      class CronTimeRangeValue
    {
        ...
        public static bool TryParse(string value, out CronTimeRangeValue timeRange)
        {
            timeRange = null;
            ...
            timeRange = new CronTimeRangeValue(list);
            return true;
        }

        CronTimeRangeValue(List<TimeRange> list)
        {
            this.rangeList = list;
        }
