...
namespace SkeFramework.Schedule.NetJob.CronExpression
{
    ...
    public class CronDayValue
    {
        ...
        public static bool TryParse(string value, out CronDayValue crontabValue)
        {
            crontabValue = null;
            ...
            foreach (var item in array)
            {
                if (item == "*" || item == "*/1")
                {
                    crontabValue = new CronDayValue(null, null);
                    return true;
                }
            ...
            {
                crontabValue = new CronDayValue(list, listDyn);
                return true;
            }
        }


        CronDayValue(List<CronNodeBase> list, List<CrontabDynamicEndValueNode> listDyn)
        {
