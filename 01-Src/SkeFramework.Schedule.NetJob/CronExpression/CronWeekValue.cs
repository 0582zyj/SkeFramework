...
namespace SkeFramework.Schedule.NetJob.CronExpression
{
      ...
      class CronWeekValue
    {
        ...
        public static bool TryParse(string value, out CronWeekValue crontabValue)
        {
            crontabValue = null;
            ...
            foreach (var item in array)
            {
                if (item == "*" || item == "*/1")
                {
                    crontabValue = new CronWeekValue(null);
                    return true;
                }
            ...
            {
                crontabValue = new CronWeekValue(list);
                return true;
            }
        }

        CronWeekValue(List<CronNodeBase> list)
        {
            this.list = list;
        }
